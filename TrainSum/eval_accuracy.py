...
device='cuda'
# モデルの準備
model_before = AutoModelForCausalLM.from_pretrained("./model/train_distillmodel2")
model_after = AutoModelForCausalLM.from_pretrained("./model/distill2_teacher1distill")
...
print("acc", acc_before/size)
print("acc", acc_after/size)
